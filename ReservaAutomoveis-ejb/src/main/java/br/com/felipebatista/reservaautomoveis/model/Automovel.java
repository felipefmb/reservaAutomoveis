...
public class Automovel implements Entidade, Serializable {
    ...
    @Column(name = "pessoa", nullable = true, unique = false, length = 100)
    private String pessoa;

    @Column(name = "renavan", nullable = true, length = 17, unique = false)
    private String renavan;

    @Column(name = "cor", length = 50, nullable = true, unique = false)
    private String cor;
